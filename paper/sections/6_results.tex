...
%events to the client's in-memory journal.}\vspace{-3ex}\label{fig:composable-mechanisms}}
%\end{figure}
...
open/create throughput of the underlying file system~\cite{shi:vldb15-spark}; Big Data Benchmark jobs
...
%The alternative is to pause the client completely and
