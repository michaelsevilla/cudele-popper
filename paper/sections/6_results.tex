...
number of concurrent journal merge events in FigureX. The size of each journal
is 100K files, the maximum recommended directory size for CephFS. We also plot
