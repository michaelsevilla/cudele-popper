...
%POSIX-compliant but relaxes durability constraints, so it can reside under a
%POSIX subtree that is strongly consistent. These embeddable policies should be
