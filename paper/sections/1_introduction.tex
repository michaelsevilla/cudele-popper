...
implement important scheduling and timing semantics, and  \oldcomment{; for
...
global namespace.  For performance, clients \oldcomment{can} relax consistency on their
...
\begin{enumerate}
  ...
  \item A framework and API for assigning consistency/durability policies to
  subtrees in the file system namespace; this lets
  \oldcomment{users}\newcomment{administrators} navigate the trade-offs of
...
optimal), and end-users checking for partial results (only a 2\% overhead).}
