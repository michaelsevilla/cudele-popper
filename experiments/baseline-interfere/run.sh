...
#  #for i in `seq 0 2`; do
#  #  ./ansible-playbook.sh -e site=$site -e nfiles=98000 ../workloads/creates.yml
#  #done
#  
#  # baseline the drop delays
#  ./ansible-playbook.sh -e site=$site -e nfiles=98000 -e drop_delay=30 ../workloads/stat.yml
#  ./ansible-playbook.sh -e site=$site -e nfiles=98000 -e drop_delay=30 ../workloads/touch.yml
#
